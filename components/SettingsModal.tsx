...
export const SettingsModal: React.FC<SettingsModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-ink/20 backdrop-blur-sm animate-in fade-in duration-200" onClick={onClose}>
      <div 
      ...
      >
        <div className="flex items-center gap-2 mb-6 border-b-2 border-ink pb-4">
             ...
             <h2 className="font-mono text-xl font-bold text-ink uppercase tracking-tighter">Configuration</h2>
        </div>
        ...
        <div className="space-y-6">
            ...
            <div 
                ...
                onClick={toggleAI}
            >
                <div className={`mt-1 w-6 h-6 border-2 border-ink flex items-center justify-center transition-colors shadow-[2px_2px_0px_0px_rgba(26,26,26,0.3)] ${settings.enableAI ? 'bg-accent' : 'bg-white'}`}>
                    {settings.enableAI && (
                ...
                <div className="flex-1">
                    ...
                    <p className="font-mono text-xs text-ink/60 leading-relaxed">
                        Allow the experimental typewriter intelligence to help polish text and continue thoughts.
                    </p>
                </div>
            </div>
